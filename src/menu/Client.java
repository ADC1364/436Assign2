...
public class Client {
	...
	public static void main(String[] args) {
		...
		System.out.println("#####################################");
		System.out.println("Option 1: Please select a price and the items at or below that price will be displayed.");
		System.out.println("Option 2: Display heart healthy options.");
		System.out.println("Option 3: Please select a category of a dish and the items in that category will be displayed.");
		...
		case 3:
			...
			System.out.println("#####################################");
			System.out.println("Option 1: Appetizers");
			System.out.println("Option 2: Main Dishes");
			System.out.println("Option 3: Desserts");
			System.out.println("#####################################");
		...
		case 4:
			...
			while(itr.hasNext()) {
				...
				item = itr.next();
				System.out.println(item.getName());
				System.out.println("Do you wish to delete this item, if yes hit d.");
				delete = input.next();
				if(delete.contentEquals("d"))
					eatAtJoesMenu.delete(item);
